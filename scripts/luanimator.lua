...
function luAnimator.SEbinds()
  ...
  if input.bindDown("luanimator", "nextform") then
    luAnimator.nextForm()
  end
  if input.bindDown("luanimator", "prevform") then
    luAnimator.previousForm()
  end
  if input.bindDown("luanimator", "sit") then
    luAnimator.toggleSitting()
  end
end
...
function luAnimator.animating()
  if luAnimator.isAnimating and luAnimation then
    ...
    if state then
      if not state.emotes[emote] or luAnimator.justEvolved then emote = "idle" end
